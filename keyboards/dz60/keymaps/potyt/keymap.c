...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LY_NAVI] = LAYOUT_60_ansi_split_bs_rshift(
            _______,     ALT_1,       ALT_2,       ALT_3,       ALT_4,       ALT_5,       ALT_6,       ALT_7,       ALT_8,       ALT_9,       ALT_0,     _______,     _______,     _______,     _______,
            _______,     _______,     KC_UP,       _______,     _______,     _______,     _______,     _______,     _______,     _______,     ALT_P,       _______,     _______,                  _______,
	    _______,     KC_LEFT,     KC_DOWN,     KC_RIGHT,    _______,     _______,     KC_LEFT,     KC_DOWN,     KC_UP,       KC_RGHT,     _______,     _______,                               _______,
            _______,     _______,     _______,     _______,     _______,     _______,     ALT_N,       _______,     _______,     _______,     _______,                  _______,                  _______,
            _______,     _______,     _______,                               _______,                                            _______,     _______,                  _______,                  _______
    ),
